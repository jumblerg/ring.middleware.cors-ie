...
(deftask reload
  ...
  (fn [continue]
    (fn [event]
      ...
      (require 'ring.middleware.cors-ie-test      :reload)
      (require 'ring.middleware.cors-ie :reload)
      (continue event) )))
...
(deftask develop
  ...
  []
  (comp (watch) (hear) (test 'ring.middleware.cors-ie) (reload 'ring.middleware.cors-ie-test 'ring.middleware.cors-ie)) )